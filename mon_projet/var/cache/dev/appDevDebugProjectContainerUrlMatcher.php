    ...
    public function match($pathinfo)
    {
        ...
        if (0 === strpos($pathinfo, '/film')) {
            ...
            if (preg_match('#^/film/(?P<id>\\d+)$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'dev_film_default_show')), array (  '_controller' => 'Dev\\FilmBundle\\Controller\\DefaultController::showAction',));
            }
