...
class appDevDebugProjectContainer extends Container
{
    ...
    {
        $this->services['cache.app'] = $instance = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('h2-fS4JfUI', 0, (__DIR__.'/pools'));
    ...
    {
<<<<<<< HEAD
        return $this->services['cache.system'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('BTYidvhs4d', 0, '8Dn2zigoztYmbUUOk6HCp0', (__DIR__.'/pools'), $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE));
=======
        return $this->services['cache.system'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('BTYidvhs4d', 0, '+jv2hVNpG2fjTEOxlDkf7g', (__DIR__.'/pools'), $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE));
>>>>>>> re
    }
...
>>>>>>> re
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'ds_biblio', 'user' => 'root', 'password' => 'root', 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), $b, $c, array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService($lazyLoad = true)
    {
        ...
        $a->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($this->get('annotation_reader'), array(0 => ($this->targetDirs[3].'/src/Devschool/BiblioBundle/Entity'))), 'Devschool\\BiblioBundle\\Entity');

        $b = new \Doctrine\ORM\Configuration();
        $b->setEntityNamespaces(array('DevschoolBiblioBundle' => 'Devschool\\BiblioBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_8c6dda2ab7ed38d2c0253c92bfcb98fe3b141aeefb9b5893859f302449ce8f3e');
    ...
    {
<<<<<<< HEAD
        return $this->services['property_accessor'] = new \Symfony\Component\PropertyAccess\PropertyAccessor(false, false, \Symfony\Component\PropertyAccess\PropertyAccessor::createCache('yuf953FVpd', NULL, '8Dn2zigoztYmbUUOk6HCp0', $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE)));
=======
        return $this->services['property_accessor'] = new \Symfony\Component\PropertyAccess\PropertyAccessor(false, false, \Symfony\Component\PropertyAccess\PropertyAccessor::createCache('yuf953FVpd', NULL, '+jv2hVNpG2fjTEOxlDkf7g', $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE)));
>>>>>>> re
    }
...
>>>>>>> re
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'/src/Devschool/BiblioBundle/Resources/views'), 'DevschoolBiblio');
        $instance->addPath(($this->targetDirs[3].'/src/Devschool/AdminBundle/Resources/views'), 'DevschoolAdmin');
<<<<<<< HEAD
        $instance->addPath(($this->targetDirs[3].'/src/Dev/FilmBundle/Resources/views'), 'DevFilm');
        $instance->addPath(($this->targetDirs[3].'/src/Dev/AdminBundle/Resources/views'), 'DevAdmin');
=======
>>>>>>> re
    ...
    {
<<<<<<< HEAD
        return $this->services['cache.annotations'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('3qETXYWS+Z', 0, '8Dn2zigoztYmbUUOk6HCp0', (__DIR__.'/pools'), $this->get('monolog.logger.cache'));
=======
        return $this->services['cache.annotations'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('3qETXYWS+Z', 0, '+jv2hVNpG2fjTEOxlDkf7g', (__DIR__.'/pools'), $this->get('monolog.logger.cache'));
>>>>>>> re
    }
    ...
    {
<<<<<<< HEAD
        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('5891d9c23f98c1.37211854')), true);
=======
        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('5891ad4a391568.64204966')), true);
>>>>>>> re
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'DevschoolBiblioBundle' => 'Devschool\\BiblioBundle\\DevschoolBiblioBundle',
                'DevschoolAdminBundle' => 'Devschool\\AdminBundle\\DevschoolAdminBundle',
<<<<<<< HEAD
                'DevFilmBundle' => 'Dev\\FilmBundle\\DevFilmBundle',
                'DevAdminBundle' => 'Dev\\AdminBundle\\DevAdminBundle',
=======
>>>>>>> re
